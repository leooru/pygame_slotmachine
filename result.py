class CreateResults:
    def __init__(self,icon_dict):
        ...
        self.icon3_name = ""
        self.icon4_name = ""
        #für amount_combination Variablen
        self.amount_icon = 1
        self.counter = True
        self.icon1_2 = 0
        self.icon2_3 = 0
    ...
    def amount_combination(self, icon1, icon2, icon3, icon4):
        """
        Diese funktion schaut, wie viele gleiche icons nebeneinander liegen
        z.b. icon1=apple, icon2= apple, icon3 = banana, icon4 = book
        output wäre 2, weil 2 apple nebeneinander sind
        """
        self.amount_icon = 1
        self.counter = True
        self.icon1_2 = 0
    ...
    def get_icon_name(self, icon1, icon2, icon3, icon4):
        self.icon1_name = ""
        self.icon2_name = ""
        self.icon3_name = ""
        self.icon4_name = ""
